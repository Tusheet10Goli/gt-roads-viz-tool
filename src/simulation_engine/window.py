...
class Window:
    ...
    def draw_status(self):
        text_fps = self.text_font.render('t={t:.5f}'.format(t=self.sim.t), False, (0, 0, 0))
        text_frc = self.text_font.render('n={n}'.format(n=self.sim.frame_count), False, (0, 0, 0))
